...
class Blockchain:
    ...
    def add_transaction(self, sender, item, quantity):
        ...
        encrypted_transaction = self.encrypt_transaction(sender, item, quantity)
        self.pending_transactions.append(encrypted_transaction)
    
    def encrypt_transaction(self, sender, item, quantity):
...
if __name__ == "__main__":
    ...
    items = [
        ...
        "Dining Table", "Refrigerator", "Chair", "Microwave", "Washing Machine",
        "Smartphone", "Headphones", "Blender", "Monitor", "Tablet", "Camera",
        "Vacuum Cleaner", "Bookshelf"
    ]
